...
!function () {
    L.Class.LabelFeature = L.Class.Feature.extend({
        options: {name: "label"}, initialize: function (t, e) {
            ...
            var i = "#fff" === e ? "black" : "#fff", l = ['<div class="total-popup-content" style="background-color:' + e + "; color: " + i + ';">', '  <input class="tip-input hidden-el" type="text" style="color: ' + i + '" />', '  <div class="tip-layer">' + t + "</div>", '  <svg class="close" viewbox="0 0 45 35">', '   <path class="close" style="stroke:' + i + '" d="M 10,10 L 30,30 M 30,10 L 10,30" />', "  </svg>", "</div>"].join("");
            return l
        }, drawTooltipHandlers: function (t, e, i) {
            var l = this, o = e, n = i ? i : "Untitled", a = "ruler" === e.options.type, s = (this.core._map, e.options.title.split(" ")), r = {
                scalar: s[0],
                unit: s[1]
            };
            this.SUB_UNIT_CONV = 1e3, "imperial" === this.options.unitSystem && (this.SUB_UNIT_CONV = 1);
            var c = {
                latlng: t.latlng,
                total: r,
                total_label: e.total,
...
!function () {
    L.Class.RulerFeature = L.Class.LineFeature.extend({
        options: {name: "ruler"}, initialize: function (t) {
            ...
            var o, r, l, h, u, p, c, f = t[1], y = t[0], m = y.distanceTo(f) / this.UNIT_CONV, U = m, C = n.measure || this.measure, N = this.core._map.latLngToContainerPoint(f), T = this.core._map.latLngToContainerPoint(y), d = 1, g = s, F = !0;
...
!function () {
    L.Class.StyleFeature = L.Class.ControlFeature.extend({
        options: {
            ...
            var i = "#fff" === e ? "black" : "#fff", n = ['<div class="total-popup-content" style="background-color:' + e + "; color: " + i + ';">', '  <input class="tip-input hidden-el" type="text" style="color: ' + i + '" />', '  <div class="tip-layer">' + t + "</div>", '  <svg class="close" viewbox="0 0 45 35">', '   <path class="close" style="stroke:' + i + '" d="M 10,10 L 30,30 M 30,10 L 10,30" />', "  </svg>", "</div>"].join("");
            return n
            ...
            i.enable(), this.buildPaneHeader(), this.buildPaneSection("color", function () {
                t.paintColor.addEventListener("click", function (e) {
                    if (L.DomEvent.stop(e), L.DomUtil.hasClass(e.target, "clickable")) {
                        var i = "SPAN" === e.target.nodeName ? e.target.parentElement : e.target, n = i.getAttribute("color"), a = i.parentElement, o = a.childNodes;
                ...
                t.paintDashArray.addEventListener("click", function (e) {
                    if (L.DomEvent.stop(e), L.DomUtil.hasClass(e.target, "clickable")) {
                        var i = "svg" === e.target.nodeName ? e.target : e.target.parentElement, n = i.childNodes, a = Math.round((e.offsetY - 10) / 20);
    ...
    L.Control.LinearCore = L.Control.extend({
        options: {
            ...
            t.on("shape_toggle", function (t) {
                var i = t.id, a = e.getGeoJson(i), s = Fe.getLayerById(i);
